...
abstract: |
  ...
  with per-stage schema validation and structured error propagation. A secondary
  finding is the gap between claimed and implemented behavior: ToolFS's documented
  WASM sandbox is an unimplemented stub. All experiments are reproducible via the
  public LiveFoldersFS repository.
---
